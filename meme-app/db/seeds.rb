...
meme1 = Meme.create(title: "Cat meme", likes: 0, description: "Funny cats LOL", image_url: "https://i.pinimg.com/736x/4d/8e/cc/4d8ecc6967b4a3d475be5c4d881c4d9c.jpg", user_id: user6.id)
meme2 = Meme.create(title: "Javascript in a nutshell", likes: 0, description: "This dog GETS it.", image_url: "https://i.barkpost.com/wp-content/uploads/2015/02/featmeme.jpg?q=70&fit=crop&crop=entropy&w=808&h=500", user_id: user2.id)
meme3 = Meme.create(title: "Spider", likes: 0, description: "me irl", image_url: "https://ichef.bbci.co.uk/images/ic/704xn/p072ms6r.jpg", user_id:user6.id)
meme4 = Meme.create(title: "Bern It!", likes: 0, description: "I am once again asking for your meme.", image_url: "https://i.redd.it/vakvnwrlzvc61.jpg", user_id: user3.id)
